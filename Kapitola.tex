...
ukázce \autoref{c:bib}, který je celý v přílohách v ukázce 
\autoref{c:large-code-block}. Se syntaxí zdrojů poradí \LaTeX 
~Workshop ve VS Code.
...
Abychom mohli přidat přílohu, musíme obrátit zraky na soubor 
\cinline{Apendicies.tex}. Do tohoto souboru můžeme vkládat všechny možné 
ústřižky kódu, obrázky apod. Můžeme je také rozdělit na kapitoly pomocí 
\cinline{\bs chapter}. Každá kapitola má taky vlastní písmenko, které se
mění automaticky.

\section{Seznamy}

Seznamy můžeme vytvářet buď pomocí \cinline{ul} (Unordered list)
anebo \cinline{ol} (Ordered list). Ordered list vytvoří seřazený seznam, 
tedy seznam s číslami, narozdíl od Unordered list, který má pouze tečky.
Abychom oddělili jednotlivé položky, vložíme na začátek řádku s položkou 
\cinline{\bs item}.

Tady je seřazený seznam:
\ol{
    \item něco zaprvé
    \item něco zadruhé
    \item něco zatřetí
